...
void LoadResources()
{
	...
	mario->LoadSpritesElement(textures, texMario, sprites);
	

	LPDIRECT3DTEXTURE9 texMisc = textures->Get(ID_TEX_MISC);
	brick->LoadSpritesElement(textures, texMisc, sprites);

	LPDIRECT3DTEXTURE9 texEnemy = textures->Get(ID_TEX_ENEMY);
	goomba->LoadSpritesElement(textures, texEnemy, sprites);
