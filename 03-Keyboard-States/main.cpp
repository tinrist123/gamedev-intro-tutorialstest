...
void LoadResources()
{
	...
	sprites->Add(10004, 5, 154, 21, 182, texMario);
	sprites->Add(10005, 425, 154, 441, 182, texMario);
	...
	CMario::AddAnimation(402);		// stop left
	CMario::AddAnimation(403);		// stop right

	//mario->SetPosition(0.0f, 480.0f);
}
